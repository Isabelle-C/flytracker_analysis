...
class Transform:
    ...
    def get_target_sizes_df(fly1, fly2, xvar="pos_x", yvar="pos_y"):
        ...
        for ix in fly1.index.tolist():
            ...
            female_size_deg_maj = calculate_female_size_deg(xi, yi, f_ori, f_len_maj)
            female_size_deg_min = calculate_female_size_deg(xi, yi, f_ori, f_len_min)
            female_size_deg = np.max([female_size_deg_maj, female_size_deg_min])
            fem_sizes.append(female_size_deg)
